...
public class Deck {
	...
	public void playGame() {
		...
		System.out.println("What card number would you like to discard? Please give the associated number.");
	...
	public void printResult() {
		if (deck.getNumCards() == 2)
			System.out.println("Sorry, the game has ended in a draw because your card number is not right .");
	...
	public void playTurn(int player) {
		...
		if (player == 1) {
			...
			if (hand1.canPlay(discardPile.getTopCard())) {
				...
				System.out.println("What card you like to discard? Please give the associated number.");
				int card = stdin.nextInt();
